                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <p class="mb-3">
                                            ${product.factory} -
                                            <c:choose>
                                                <c:when test="${product.target == 'GAMING'}">Gaming</c:when>
                                                <c:when test="${product.target == 'SINHVIEN-VANPHONG'}">Sinh viên, văn
                                                    phòng</c:when>
                                                <c:when test="${product.target == 'THIET-KE-DO-HOA'}">Thiết kế đồ họa
                                                </c:when>
                                                <c:when test="${product.target == 'MONG-NHE'}">Mỏng nhẹ</c:when>
                                                <c:when test="${product.target == 'DOANH-NHAN'}">Doanh nhân</c:when>
                                            </c:choose>
                                        </p>
